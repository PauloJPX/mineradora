...
from routes import auth, usuarios, menu, clientes, vendas, inicio,  caminhoes, entregas, consultas
...
def require_login():
    ...
    listaMenu= ['vendas.', 'usuarios.', 'menu.', 'clientes.', 'caminhoes.', 'entregas.', 'consultas.']
