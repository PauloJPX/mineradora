...
from routes import auth, usuarios, menu, clientes, vendas, inicio,  caminhoes, entregas, consultas, produtos
...
def require_login():
    ...
    listaMenu= ['vendas.', 'usuarios.', 'menu.', 'clientes.', 'caminhoes.', 'produtos.', 'entregas.', 'consultas.']
